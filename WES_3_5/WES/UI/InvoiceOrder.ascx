...
<table id="tblBase" class="" align="center" width="100%" border="0px"
               ...
               <%-- <tr>
                ...
                <tr>
                    ...
                    <% 
                       ...
                       else if ((oOrderInfo.ShipMethod == "Courier") || (oOrderInfo.ShipMethod == "Mail"))  
                              {                                                           
                                 %>
 <td colspan="4" rowspan="5" bgcolor="white" valign="top" align="right">
             ...
             <%--   <%
                 ...
                 <tr>
                    ...
                    if ( (objOrderServices.IsNativeCountry(OrderID) == 0))
                    {
                        ...
                        {
                             if (objHelperServices.CDEC(oOrderInfo.ShipCost) > 0)
                                       {
             ...
             <%--   <%} %>--%>
                 <%-- <%
                     if ((oOrderInfo.ShipMethod == "Courier") || (oOrderInfo.ShipMethod == "Mail"))  
                              {                                                           
                                 %>
                            <tr>
                            ...
                            <asp:Label ID="lblshipingcost" runat="server" Visible="false" />
                                   <%   Response.Write(CurSymbol + " " + objHelperServices.CDEC(oOrderInfo.ShipCost)); %>
                                    </td>
                            </tr>
                            <% } %>--%>
     ...
     <%       
         if (((oOrderInfo.ShipMethod == "Courier") || (oOrderInfo.ShipMethod == "Mail")) && (ispickuponly_zone(OrderID) == false))
                 {
