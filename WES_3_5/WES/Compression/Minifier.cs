...
namespace AspMinifier
{
    public class Minifier
    {
        ...
        public Stream   Minify(Stream DataStrem, string extension)
        {
            Backup = false;
            DataStrem.Position = 0;
            StreamReader reader = new StreamReader(DataStrem);
        ...
        public string Minify(string data, string extension)
        {
            Backup = false;
