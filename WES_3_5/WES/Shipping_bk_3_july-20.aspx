        ...
        function Onload_drpcheck() {
            ...
            if (($("#<%=drpSM1.ClientID%> option:selected").text() == "Shop Counter Pickup")) {
                ...
                if ((mblnumber.substring(0, 2) == "04" && mblnumber.length == 10)) {
                    ...
                    alert(document.getElementById("ctl00_maincontent_hfrole3").value);
...
//            console.log(i);
//            if (i == "ImageButton2") {
//                //  document.getElementById('<%= ImageButton2.ClientID %>').disabled = true;
//                document.getElementById('<%= ImageButton2.ClientID %>').value = 'Processing…';

//            }
//            else if (i == "btndirectdeposit") {
//                // document.getElementById('<%= btndirectdeposit.ClientID %>').disabled = true;
//                document.getElementById('<%= btndirectdeposit.ClientID %>').value = 'Processing…';

//            }
//            else if (i == "btnpayonacc") {
//                //  document.getElementById('<%= btnpayonacc.ClientID %>').disabled = true;
//                document.getElementById('<%= btnpayonacc.ClientID %>').value = 'Processing…';
//            }
//            else if (i == "btnmastercard") {
//                //  document.getElementById('<%= btnmastercard.ClientID %>').disabled = true;
//                document.getElementById('<%= btnmastercard.ClientID %>').value = 'Processing…';

//            }
//            else if (i == "btnPay") {
//                // document.getElementById('<%= btnPay.ClientID %>').disabled = true;
//                document.getElementById('<%= btnPay.ClientID %>').value = 'Processing…';
//            }

//            else if (i == "btnSP") {
//                // document.getElementById('<%= btnSP.ClientID %>').disabled = true;
//                document.getElementById('<%= btnSP.ClientID %>').value = 'Processing…';
          //  }
                    var form = document.getElementById("aspnetForm");
                    var elements = form.elements;
                    for (var i = 0, len = elements.length; i < len; ++i) {
...
//                $("#DivLoaderContainer").style.display = "none";
        ...
        function btnimagebutton_click(refid) {
           ...
           // document.getElementById("divLoader").style.display = 'block';
            ...
            if ($('#<%=drpSM1.ClientID%> option:selected').val() == "Drop Shipment Order") {
                ...
                shipinfo.drpstate = $("#<%=drpstate_txt.ClientID%> option:selected").val();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.RedirectTo != "") {
                        ...
                        $("#<%=tt1.ClientID%>").setAttribute('disabled', 'disabled');


                        if (shipinfo.drpSM1 == "Drop Shipment Order") {
                            $("#<%=txtCompany.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtAttentionTo.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtAddressLine1.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtAddressLine2.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtSuburb.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=drpShipState.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtCountry.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtPostCode.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtShipPhoneNumber.ClientID%>").setAttribute('disabled', 'disabled');
                            $("#<%=txtDeliveryInstructions.ClientID%>").setAttribute('disabled', 'disabled');
        ...
        function btnSecurePay() {
            ...
            if (returntype == false) {
                ...
                var expyr = $('#<%=drpExpyear.ClientID%> option:selected').val();
                ...
                shipinfo.expmonth = $('#<%=drpExpmonth.ClientID%> option:selected').val();
                shipinfo.expyr = $('#<%=drpExpyear.ClientID%> option:selected').val();
                shipinfo.lblshipingcost = $('#<%=lblshipingcost.ClientID%>').text();
                shipinfo.shipcode = $('#<%=hfshipcode.ClientID%>').val();
                if ($('#<%=drpSM1.ClientID%> option:selected').val() == "Drop Shipment Order") {
                    shipinfo.drpShipCompName = $("#<%=txtCompany.ClientID%>").val();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //                        }
                            ...
                            if (message == "Error found in details you have entered. Please Select valid expiry date.") {
                                $("#<%=div2.ClientID%>").text(message);
                            ...
                            if (message.toString().toLowerCase().includes("date") || message.toString().toLowerCase().includes("expired")) {
                                ...
                                $("#<%=drpExpyear.ClientID%>").css("border", "1px solid #FF0000");
                                $("#<%=RBexpirydate.ClientID%>").css("display", "block");
                            }
                            else {
                                $("#<%=drpExpyear.ClientID%>").css("border", "");
...
//            }
    ...
    <script type="text/javascript">
        ...
        function closeModelPopup(btn) {
            ...
            if (document.getElementById("ctl00_maincontent_TextBox1").value == '' && document.getElementById("ctl00_maincontent_tt1").value != '' && ($("#<%=drpSM1.ClientID%> option:selected").text() == "Courier Pickup")) {
        ...
        <tr>
            ...
            <tr>--%>
                ...
                <td style="width: 135px; height: 135px;  background-color:#ffdb01;border: 0;
                    ...
                    <div class="alert greenbox icon_2" style="padding: 30px 10px 30px 60px; display: none"
                    ...
                    <div class="quickorder4">
                        ...
                        <div id="DropShipmentRow" style="display: none">
                            <div class="alert yellowbox">
                                ...
                                <div class=" form-col-3-8">
                                    <asp:TextBox ID="txtShipPhoneNumber" runat="server" Width="242px" MaxLength="40"
            ...
            <tr>
                <td>
                    <asp:Label ID="lblweight" runat="server" Visible="true" font-color="gray" Font-Names="Arial"
                        Font-Size="20px" Font-Bold="true" Text=""></asp:Label>
                                        ...
                                        <div class="payment_btns">
                                            <div style="width: 70%; display: block; float: left">
                                                ...
                                                <label for="contactChoice2" class="form-col-3-8 payment_radio" id="lblcreditcard">
                                                    ...
                                                    <div>
                                                        <img src="../images/credit_card.png" alt="" runat="server" id="imgsecurepay" /></div>
                                                </label>
                                            ...
                                            <div class="payment_contents" style="display: none; margin-top: 20px" id="divcreditcard"
                                                runat="server">
                                                <div id="creditflag1" runat="server">
                                                    <div class="form-col-6-8">
                                                        ...
                                                        <div class="creditcard_pay" id="ccfocus">
                                                            ...
                                                            <div class="form-col-4-8">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RBexpirydate" runat="server" class="vldRequiredSkin_creditcard"
                                                                    ErrorMessage="Please Enter Expiry Date" ControlToValidate="drpExpyear" ValidationGroup="payonlinepaynow"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                        <div class="clear">
                                                        </div>
                                                ...
                                                <div id="creditflag2" runat="server">
                                                    ...
                                                    <div id="divFailed" style="display: none; text-align: center; background: #FFF200;
                                                        font-size: 12px" class="alert yellowbox icon_2">
                                                        Transaction failed!
                                                        <div id="diverrorno">
                                                            Please Try again or use a different card / payment method.</div>
                                                    </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (result.RedirectTo != "") {
                            ...
                            var x = document.getElementsByClassName("braintree-large-button");
                            x[0].outerHTML = '<div data-braintree-id="toggle" class="braintree-large-button braintree-toggle" tabindex="0" style="background:white;border:none;display:block" onclick="hide()"><span onclick="hide()">Choose another way to pay</span></div>';
                            enableFrm();
                            //x[0].innerHTML = '<span  onclick=hide()>Choose another way to pay</span>';
                            //alert(x[0].outerHTML);
