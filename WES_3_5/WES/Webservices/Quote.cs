        ...
        {
            {
                ...
                if (dsOD != null)
                    ...
                    {
                        rInfo.QuoteID = oHelper.CI(drOD["QUOTE_ID"]);
                        rInfo.QuoteFName = oHelper.CS(drOD["QUOTE_FNAME"]);
                        rInfo.QuoteLName = oHelper.CS(drOD["QUOTE_LNAME"]);
                        rInfo.QuoteAdd1 = oHelper.CS(drOD["QUOTE_ADDRESS1"]);
                        rInfo.QuoteAdd2 = oHelper.CS(drOD["QUOTE_ADDRESS2"]);
                        rInfo.QuoteAdd3 = oHelper.CS(drOD["QUOTE_ADDRESS3"]);
                        rInfo.QuoteCity = oHelper.CS(drOD["QUOTE_CITY"]);
                        rInfo.QuoteState = oHelper.CS(drOD["QUOTE_STATE"]);
                        rInfo.QuoteZip = oHelper.CS(drOD["QUOTE_ZIP"]);
                        rInfo.QuoteCountry = oHelper.CS(drOD["QUOTE_COUNTRY"]);
                        rInfo.QuoteEmail = oHelper.CS(drOD["QUOTE_EMAIL"]);
                        rInfo.QuotePhone = oHelper.CS(drOD["QUOTE_PHONE"]);
                        rInfo.QuoteComments = oHelper.CS(drOD["QUOTE_COMMENTS"]);
                        rInfo.UserID = oHelper.CI(drOD["USER_ID"].ToString());
                        rInfo.QuoteStatus = oHelper.CI(drOD["QUOTE_STATUS"]);
