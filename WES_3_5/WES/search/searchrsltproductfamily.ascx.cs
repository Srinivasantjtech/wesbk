                ...
                foreach (DataRow drpid in dscat.Tables["FamilyPro"].Rows)
                {
                  ...
                  //  string urlDesc = "";
                    ...
                    else
                    {
                        ...
                        if (drpid["QTY_AVAIL"] != null && Convert.ToInt32(drpid["QTY_AVAIL"].ToString()) != -1)
                        {
                    ...
                    else
                    {
                        ...
                        if(drpid["Family_Description"]!=null && drpid["Family_Description"].ToString()!="")
                        { 
                       ...
                       // objErrorHandler.CreateLog(descattr + "--" + _stmpl_records.GetAttribute("PROD_DESC_ALT").ToString());
                        if (descattr.Length > 140 && _ViewType == "GV")
                        {
                            int count = 0;
                            count = descattr.Count(c => char.IsUpper(c));
                           ...
                           // objErrorHandler.CreateLog("count" + count + "count1" + count1);
                            if (count >= 35)
                            {
                                ...
                                descattr = descattr.Substring(0, descattr.LastIndexOf(" "));
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC", descattr);
                              //  objErrorHandler.CreateLog("inside 1"+ descattr);
                            }
                            else if (descattr.Length > 140 && count < 35 && count1 > 10)
                            {
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC_GV", true);
                                descattr = descattr.Substring(0, 135).ToString();
                               // objErrorHandler.CreateLog(descattr.Substring(descattr.Length - 1)+ _stmpl_records.GetAttribute("PROD_DESC_ALT").ToString());
                                //if (descattr.Substring(descattr.Length - 1) == ",")
                                //{
                                
                                    descattr = descattr.Substring(0, 134).ToString().Replace(",","");
                                //}
                                descattr = descattr.Substring(0, descattr.LastIndexOf(" "));
                              
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC", descattr);
                              //  objErrorHandler.CreateLog("inside 2 " + _stmpl_records.GetAttribute("ATTRIBUTEDESC"));
                            }
                            else if (descattr.Length > 140 && count < 35 && count1 < 10)
                            {
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC_GV", true);
                                ...
                                descattr = descattr.Substring(0, descattr.LastIndexOf(" "));
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC", descattr);
                              //  objErrorHandler.CreateLog("inside 3" + descattr);
                            }
                            else
                            {
                                _stmpl_records.SetAttribute("ATTRIBUTEDESC_GV", true);
                        ...
                        else
                        {
                            ...
                            _stmpl_records.SetAttribute("ATTRIBUTEDESC", descattr);
                            //objErrorHandler.CreateLog("inside5" + descattr);
                        }
                    }
