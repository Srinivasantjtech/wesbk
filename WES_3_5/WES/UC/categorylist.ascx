<%@ Control Language="C#" AutoEventWireup="true" Inherits="UC_categorylist" Codebehind="categorylist.ascx.cs" %> <%@ Register Src="newproducts.ascx" TagName="newproducts" TagPrefix="uc1" %> <input id="HidItemPage" type="hidden" runat="server" /> <%--<script type="text/javascript" src="../scripts/jquery-1.4.1.min.js"></script> <script type="text/javascript" src="../scripts/jquery-1.10.2.min.js"></script>--%>
...
});</script> <script  type="text/javascript"> function ImgLoad(v) {
...
{%> <table width="782px" align="center" > <%}%> <tr> <td align="center"> <table width="100%" border="0" cellspacing="0" cellpadding="0" onload="Getfidfromurl();"> <tr> <td align="left" class="tx_1"> <div class="br" style="margin-left:-3px;" > <%
Response.Write(Bread_Crumbs());
%> </div> </td> </tr> </table> </td> </tr> <tr> <td height="3px"> </td> </tr> </table> <% Response.Write(ST_CategoryList()); %> <% 
if ((Request.Url.ToString().ToLower().Contains("categorylist.aspx")) && Request.QueryString["tsb"] == null )
{
%> <div style="margin: 0 0 0 4px;" class="box1"> <table id="tblmain"> <tr>
    <td >
        <%   Response.Write(ST_CategoryProductList());  %> 

    </td>

                                                                      </tr> <tr> <td> <table id="tblload" style="display:none;" width="325px" align="center"> <tr> <td> <div width="300px" align="center"><img src="images/bigLoader.gif" width="12%" height ="12%"></div> </td> </tr> <tr> <td align="center"> <asp:Label ID="Label1" runat="server" Text="LOADING DATA...PLEASE WAIT"
Font-Bold="True" Font-Names="Arial" Font-Size="X-Small" ></asp:Label> </td> </tr> </table> </td> </tr> <tr> <td> <table id="databottom" width="775px" bgColor="#f2f2f2" border="0" cellSpacing="0" cellPadding="0" style="display:none;" class="box2"> <tr> <td height="35" width="156" align="left"> </td> <td width="303" align="middle"> </td> <td width="175" align="right"> </td> </tr> </table> <asp:HiddenField ID="HiddenField2" runat="server" /> <asp:HiddenField ID="HiddenField1" runat="server" /> <asp:HiddenField ID="HFcnt" runat="server" /> <asp:HiddenField ID="hfcheckload" runat="server" /> <asp:HiddenField ID="hforgurl" runat="server" /> <input type="text" name="eapath" id="htmleapath" runat="server" style="display:none;"/> <input type="text" name="ViewMode" id="htmlviewmode" runat="server" style="display:none;"/> <input type="text" name="irecords" id="htmlirecords" runat="server" style="display:none;"/> <input type="text" name="Totalpages" id="htmltotalpages" runat="server" style="display:none;"/> <asp:HiddenField ID="hfback" runat="server" /> <asp:HiddenField ID="hfbackdata" runat="server" /> <asp:HiddenField ID="hfscrollpos" runat="server" /> </td> </tr> </table> </div> <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" > <tr> <td width="70%">&nbsp;</td> <td width="28%" align="right"> <a href="#" class="scrollup" >Top</a> </td> <td width="2%">&nbsp;</td> </tr> </table> <%    }
%> <script language="javascript"> function GetSelectedIts() {
...
} </script> <script type="text/javascript" language="javascript"> function SetSortOrder(orderVal) {
...
return false;
//OnCaptchaSuccess,
} </script> <script>$(document).ready(function(){$(document).scroll(function(){var A=".container_cmn";var D=".fixed";var B=$(window).scrollTop()+$(window).height();var C=$(A).offset().top;if(B>=C+200){$(".fixed").css("display","none")}else{$(".fixed").css("display","block");$(".fixed").css("overflow-y","auto")}})});$(function(){var B=$(window);var E=B.scrollTop();var C=true;var A=$("#Category");if(A.length>0){var D=A.position().top;B.scroll(function(S){var P=B.height();var M=A.outerHeight();var G=B.scrollTop();var R=G+P;var Q=A.position().top;var X=Q+M;var I=Math.abs(P-M);var L=E-G;var N=(G>E);var V=(P>M);if((V&&G>D)||(!V&&G>D+I)){A.addClass("fixed")}else{if(!N&&G<=D){A.removeClass("fixed")}}var K=(X<=R&&N);var T=(Q>=G&&!N);if(K){if(V){A.css("top",15)}else{A.css("top",-I)}}else{if(T){A.css("top",15)}else{if(A.hasClass("fixed")){var J=0;$(window).scroll(function(Y){});$(window).scroll(function(){if($(this).scrollTop()>200){$(".fixed").css("top","15px")}});$(window).scroll(function(){if($(window).scrollTop()>=(($(document).height()-$(window).height())-$(".fixed").innerHeight())){console.log("div reached")}});var O=parseInt(A.css("top"),10);var U=-I;var H=O+L;var F=(G+P>=$(document).height());var W=(F)?U:H;A.css("top",W)}}}E=G;C=N})}});</script> <%--<script language="javascript" type="text/javascript"> $(document).ready(function () {
