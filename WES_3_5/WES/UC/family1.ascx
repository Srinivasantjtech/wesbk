...
<script type="text/javascript">
    function test(id) {
        ...
        try
        {
            ...
            {
                position: "relative",
                left: MouseX - (menuDiv.clientWidth - 50) + '%',
                top: MouseY - (menuDiv.clientHeight + 0) + '%'
            }
            );
            }
            else {
                $(menuDiv).css(
            {
                position: "relative",
                left: MouseX - (menuDiv.clientWidth - 50) + '%',
                top: (MouseY - (menuDiv.offsetHeight + 0)) + '%'
            }
            );
            }
        }
    ...
    function createMenuDiv() {
        ...
        function Mouseout_fade(id) {
            try
            {
                ...
                document.getElementById(pidr).style.transition = 'all 2s';
                //  document.getElementById(pidr).style.opacity = 1;
                // document.getElementById(pidr).style.visibility = 'hidden';
                //  document.getElementById('testdiv').style.transition = 'all 2s';
