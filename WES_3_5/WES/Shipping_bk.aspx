...
<asp:Content ID="Content5" ContentPlaceHolderID="maincontent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function creditcardclick()
        {
            ...
            //document.getElementById("RBcreditcardno").checked = true;
        ...
        function paypalclick() {
            ...
            document.getElementById("ctl00_maincontent_ImageButton2").style.display = 'none';
            //document.getElementById("RBPaypal").checked = true;
        ...
        function Defaultclick() {
            ...
            //document.getElementById("RBdefautpaymenttype").checked = true;
...
//        }
     ...
     <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
       ...
       <%-- <table cellpadding="0" cellspacing="0" border="0" width="765" style="background: none repeat scroll 0 0 #319731;border-radius: 5px 5px 5px 5px;">
           ...
           <div class="quickorder4">
                    ...
                    <tr>
                    <td colspan="3" style="font-size: medium; color: #0099DA;">           
                    <b> Enter Your Purchase Order No</b>                                                    
                    </td>
                    </tr>                
                    <tr>
                    <td>
                    Order No <span class="redx"></span>
                    </td>
                    <td>
                    <asp:TextBox Width="242px" MaxLength="12" ID="tt1" runat="server" BackColor="White" CssClass="input_dr" onkeypress="blockspecialcharforOrder(event)" />
  ...
  <%--  <br />--%>
   ...
   <%-- <table width="100%"   class="shippingtable">--%>
       <%-- <tr>
            <td colspan="4" style="font-size: medium; color: #0099DA;">  
                                                       
             </td>
            </tr> --%>
           <%-- <tr id="OtherShipmentRow">--%>
                       <%-- <td width="100%">
               ...
               <%--</tr>--%>
           <%-- <tr id="DropShipmentRow">
                        <td width="100%">
--%>
                        
                            <%--<div class="boxfullborder" style="background-color: #FFFF96;width: 721px;" >
                            <table width="100%" cellpadding="1" cellspacing="0" border="0" >--%>
                            <%--  <tr> <td colspan="4" height="10"></td></tr>
                             <tr>
                                    <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    </td>
                                    <td colspan="2" style="font-size:13px; color: black;">
                                        <b>Please Enter Shipment Delivery Details : </b>
                                    </td>
                                ...
                                <tr> <td colspan="4" height="5"></td></tr>--%>
                                 ...
                                 <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="26%" align="left">
                                        &nbsp;Company Name:&nbsp; <span style="color: Red; font-weight: bold;"> </span>
                                    </td>
                                ...
                                <%-- <tr>
                                 <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="25%" align="left">
                                        &nbsp;ATTN To / Receiver Name:&nbsp; <span style="color: Red; font-weight: bold;">*</span>
                                    </td>
                                    <td width="46%" align="left">
                             ...
                             <%--   <tr>
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="25%" align="left">                                   
                                        &nbsp;Receiver Contact Number: &nbsp; <span style="color: Red; font-weight: bold;">  </span>
                                    </td>
                                    <td width="46%" align="left">
                               ...
                               <%-- <tr>
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="25%" align="left">                                   
                                        &nbsp;Address line 1: &nbsp; <span style="color: Red; font-weight: bold;">* </span>
                                    </td>
                                    <td width="46%" align="left">
                             ...
                             <%--   <tr>
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                      
                                    ...
                                    <td width="25%" align="left">                                   
                                        &nbsp;Address line 2: &nbsp; <span style="color: Red; font-weight: bold;"> </span>
                                    </td>
                                    <td width="46%" align="left">
                               ...
                               <%-- <tr>
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="25%" align="left">                                   
                                        &nbsp;Suburb: &nbsp;<span style="color: Red; font-weight: bold;">* </span>
                                    </td>
                                    <td width="46%" align="left">
                               ...
                               <%--  <tr>
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="25%" align="left">                                   
                                        &nbsp;Post Code: &nbsp;<span style="color: Red; font-weight: bold;"> * </span>
                                    </td>
                                    <td width="46%" align="left">
      ...
      <%--  <tr>           
            <td align="left"  >--%>
                ...
                <%-- <div class="form-col-2-8">
                    <p class="p2">Select Shipment Method<span class="red">*</span></p>
                 </div>
                 <div class="form-col-3-8">
                      <asp:DropDownList NAME="drpSM1" Width="250px" ID="drpSM1" runat="server" CssClass="txtinput1">
                                            <asp:ListItem Text="Please Select Shipping Method" Value="Please Select Shipping Method">Please Select Shipping Method</asp:ListItem>
                 ...
                 <div class="form-col-3-8">
                   <a class="link" href="#">
                    <img id="Img11" runat="server" src="~/images/help.png" alt="" onclick="MouseHover();" style="cursor: pointer;" />
                    Learn More About Shipment Method Options 
                   </a> 
                 </div>
                 <div class="clear padbot10"></div>
                 <div class="form-col-4-8">
                    <textarea id="Ta2" cols="34"   Class="textarea" readonly="readonly" tabindex="-1" runat="server" rows="10" name="Ta2"></textarea>
                 </div>
                 <div class="form-col-4-8">
                     <textarea id="Ta3" cols="34"  Class="textarea1" readonly="readonly" tabindex="-1" runat="server" rows="10"  name="Ta3"></textarea>
                 </div>
                 <div class="clear"></div>--%>
               <%-- <table width="100%" cellpadding="1" cellspacing="0" border="0">--%>
                  ...
                  <%--  <tr>
                        <td>--%>
                            <%--<table width="100%" runat="server" cellpadding="0" cellspacing="0" border="0" id="color1">
                                <tr>
                                    <td width="2%" style="font-size: small; color: Red;">
                                        *
                                    </td>
                                    ...
                                    <td width="46%" align="left" >
                                        <asp:DropDownList NAME="drpSM1" Width="250px" ID="drpSM1" runat="server" CssClass="inputtxt">
                                            <asp:ListItem Text="Please Select Shipping Method" Value="Please Select Shipping Method">Please Select Shipping Method</asp:ListItem>
                                           <asp:ListItem Text="Courier" Value="Courier">Courier</asp:ListItem>
                                            <asp:ListItem Text="Mail" Value="Mail">Mail</asp:ListItem>                                           
                                            <asp:ListItem Text="Courier Pickup" Value="Courier Pickup">Courier Pickup</asp:ListItem>
                                    ...
                                    <td width="30%">
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                                            <tr>
                                                <td width="9%" style="vertical-align: middle; margin-top: 0px;">
                                                    <img id="Img11" runat="server" src="~/images/help.png" alt="" onclick="MouseHover();"
                                                        style="cursor: pointer;" />
                                                </td>
                                                <td width="1%">
                                                    &nbsp;
                                                </td>
                                                <td width="90%" style="vertical-align: top; margin-top: 0px; padding-bottom: 0px;">
                                                    <asp:HyperLink ID="HyperLink1" runat="server" onclick="MouseHover();" CssClass="HyperLinkStyle">
                                                        Learn More About <br /> Shipment Method Options
                                                    </asp:HyperLink>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <%--<tr id="OtherShipmentRow">
                        <td width="100%">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="49%" align="left">
                                        <textarea id="Ta2" cols="34"   Class="inputtxt" readonly="readonly" tabindex="-1" runat="server" rows="10" 
                                            name="Ta2"></textarea>
                                    </td>
                                    <td width="2%">
                                        &nbsp;
                                    ...
                                    <td width="49%" align="left">
                                        <textarea id="Ta3" cols="34"  Class="inputtxt" readonly="readonly" tabindex="-1" runat="server" rows="10" 
                                            name="Ta3"></textarea>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr id="DropShipmentRow">
                        <td width="100%">
                            <div class="boxfullborder" style="background-color: #FFFF96;width: 585px;" >
                            <table width="100%" cellpadding="1" cellspacing="0" border="0" >
                              <tr> <td colspan="4" height="10"></td></tr>
                             <tr>
                                    <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                ...
                                <tr> <td colspan="4" height="5"></td></tr>
                                 ...
                                 <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                        <asp:TextBox ID="txtCompany" runat="server" MaxLength="40" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label13" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <tr> <td colspan="4" height="5"></td></tr>
                                 ...
                                 <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                        <asp:TextBox ID="txtAttentionTo" runat="server" MaxLength="40" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label27" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                       <asp:TextBox ID="txtShipPhoneNumber" runat="server" Width="242px" MaxLength="40" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label26" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                       <asp:TextBox ID="txtAddressLine1" runat="server" MaxLength="40" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="lbladdline1err" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                      
                                    ...
                                    <td width="46%" align="left">
                                      <asp:TextBox ID="txtAddressLine2" runat="server" MaxLength="40" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="lbladdline2err" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                      <asp:TextBox ID="txtSuburb" runat="server" MaxLength="40" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label21" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                      <asp:TextBox ID="txtPostCode" runat="server" MaxLength="4" Width="242px" CssClass="inputtxt" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="lblpostcode2err" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                       <asp:TextBox ID="txtCountry" runat="server" CssClass="inputtxt" Width="242px" Text="Australia" ReadOnly="True" />
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label24" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                                ...
                                <td width="2%" style="font-size: small; color: Red;">  &nbsp;                                       
                                    ...
                                    <td width="46%" align="left">
                                       <asp:TextBox ID="txtDeliveryInstructions"  runat="server" Width="242px"    Class="textSkin" CssClass="inputtxt" MaxLength="40"   /> 
                                    </td>
                                    <td align="left">
                                        <asp:Label Width="150px" ID="Label25" runat="server" ForeColor="red"></asp:Label>
                                    </td>
                    ...
                    <tr>
                        <td rowspan="" width="75%">
                           ...
                           <div class=" payment_btns">
                                ...
                                <label for="contactChoice1" class="form-col-2-8 payment_radio " id="lbldefaultpayment" onclick="Defaultclick()" >
                                      <asp:RadioButton ID="RBdefautpaymenttype" runat="server" Text=" Master Card" GroupName="Paymentoption"/>
...
<asp:Label ID="lblmasterexpirydate" runat="server" Text="Label" style="height: 15px; display: block;"></asp:Label>
                                      ...
                                      <div runat="server" id="divdirectdeposit">
                                        <img style="display:inline-block" src="../images/deposit.png" alt=""/>
                                ...
                                <label for="contactChoice2" class="form-col-2-8 payment_radio" onclick="creditcardclick()" id="lblcreditcard">
                                     <asp:RadioButton ID="RBCreditCard" runat="server" Text="New Credit Card" GroupName="Paymentoption" ValidationGroup="payonlinepaynow" />
                              <%--  <input id="RBCreditCard" name="contact" value="phone" type="radio">--%>
                                
                                <div><img src="../images/credit_card.png" alt=""/></div>
                                </label>
                                
                                <label for="contactChoice3" class="form-col-2-8 payment_radio" id="lblpaypalcard" onclick="paypalclick()">
                                <asp:RadioButton ID="RBPaypal" runat="server"  Text="Paypal" GroupName="Paymentoption"/>
                            ...
                            <div class="payment_contents" style="display:none" id="divcreditcard" runat="server">
                            <div class="form-col-6-8">
...
<asp:TextBox ID="txtcreditcardno" runat="server" class="input_100" MaxLength="19" ValidationGroup="payonlinepaynow">
                    ...
                    <asp:DropDownList NAME="drpExpyear"  ID="drpExpyear" runat="server" class="payment_select">          
                                    ...
                                    <div>
                                            <asp:Button ID="btnSP" runat="server" Text="Pay Now"  ValidationGroup="payonlinepaynow" class="paynow" OnClick="btnSecurePay_Click"  OnClientClick="checkorderid()" />
                            ...
                            <div class="payment_contents form-col-6-8" style="display:none" id="divpaypal" runat="server" >
  ...
  <asp:Button runat="server" ID="btnPay" Text="Pay Now" class="paynow"  OnClick="btnPay_Click"  OnClientClick="checkorderid()"    />       
...
Response.Write(objHelperServices.GetOptionValues("CURRENCYFORMAT").ToString() + " " + objHelperServices.CDEC(objHelperServices.FixDecPlace(taxamt))); //objHelperServices.FixDecPlace(objHelperServices.CDEC(taxamt)));  					    
                    ...
                    <asp:Label Width="250px" ID="lblcouponerrmsg" runat="server" ForeColor="red" Visible=false  />
                        ...
                        <tr>
                            <td colspan="6" > 
                                <asp:Button ID="ImageButton1" runat="server" Text="Edit/Update Order" style="margin:10px 0 10px 490px;" OnClick="ImageButton1_Click" class="buttongray normalsiz btngray fleft"/>
                                <asp:Button runat="server" ID="ImageButton2" Text="Submit Order" style="margin:10px 0 10px 10px;" class="button normalsiz btnblue fleft"  OnClientClick="return checkorderid()" OnClick="ImageButton4_Click" />
                        </td>
                    </tr>
                    </table>
