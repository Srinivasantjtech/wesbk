      ...
      <fieldset>
         ...
         <div class="form-col-1-8"> <span style="font-size:12px;float: left;margin-top: 2px;">Payment Type</span> </div>
          ...
          <div class="form-col-2-8">
           	  <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnSecurePayLink_Click"  CausesValidation="false" ><label><img style="margin-top: -5px;cursor: pointer;" alt="cc" src="images/pay1uch.png"></label>
</asp:LinkButton>            </div>
              
            <div class="form-col-3-8">
           	    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" ><label><img style="margin-top: -5px;cursor: pointer;" alt="cc" src="images/pay2ch.png"></label></asp:LinkButton>
            </div>
            <div class="cl"></div>
