 ...
 <%--   </td>
  ...
  <%--  <table width="100%"  cellpadding="0" cellspacing="0" border="0" >
        <tr>
            ...
            <td width="100%" align="left" style="border: thin solid #E7E7E7">
   ...
   <%-- <br />--%>
    <%--<table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <td width="96%">
                <table width="100%" cellpadding="1" cellspacing="0" border="0px" style="border-style: none"
                    align="left">
                    <tr>
                        ...
                        <td width="25%" align="right">
                                ...
                                <asp:Button ID="ImageButton1" runat="server" Text="Edit/Update Order" style="color:#4e4e4e!important;margin:10px 0 10px 490px;" OnClick="ImageButton1_Click" class="button normalsiz btngray fleft"/>
                        </td>
