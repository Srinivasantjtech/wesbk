...
<script language="javascript" type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
       ...
       <script language="javascript" type="text/javascript">
           function blockspecialcharacters_ec(e) {
 ...
 <script language="javascript" type="text/javascript">
  ...
  <tr>
                            ...
                            <table cellspacing="0" width="680px" cellpadding="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="tx_1" align="left">
                                        Please fill in all details below so we can verify your account at WES.<br />
                                        Once your account has been verified by our sales team you will receive an email
                                        with<br />
                                        login details for the WES web site.<br />
                                        <br />
                                        Please note for faster / instant verification please enter all details including
                                        your customer<br />
                                        and last purchase invoice number from WES.
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="680px">
                                            <tr>
                                                <td width="170" align="left">
                                                  <span class="form_1">                                           
                                                  WES Account Number<asp:Label ID="Label1" runat="server" Class="lblRequiredSkin" Visible="true"
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <span class="form_1">     
                                                    Last purchase invoice number<asp:Label ID="Label3" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="" Width="1px"></asp:Label></span> 
                                                </td>
                                                ...
                                                <td align="left">
                                                    &nbsp;&nbsp;<%--<asp:RequiredFieldValidator ID="rfvpinno" runat="server" Class="vldRequiredSkin"
                                           ...
                                           <%-- <tr>
                                            ...
                                            <tr>
                                                <td width="118px" align="left"><span class="form_1">    
                                                    Company / Account Name<asp:Label ID="Label5" runat="server" Class="lblRequiredSkin"
                                            ...
                                            <tr>
                                                ...
                                                <span class="form_1">    
                                                    ...
                                                    ABN / ACN / Company Number<asp:Label ID="Label6" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td align="left"><span class="form_2">    
                                ...
                                <tr>
                                    ...
                                    <td class="tx_1" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="118px">
                                                    Street Address<asp:Label ID="Label7" runat="server" Class="lblRequiredSkin" Visible="true"
                                                ...
                                                <td align="left">
                                                    &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfvsadd" runat="server" Class="vldRequiredSkin"
                                                        ValidationGroup="Mandatory" Display="Dynamic" Text="Enter Street Address" ControlToValidate="txtsadd"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="textdummy">
                                            ...
                                            <tr>
                                                <td>
                                                    Suburb/Town<asp:Label ID="Label8" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td align="left">
                                                    &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfvtown" runat="server" Class="vldRequiredSkin"
                                                        ValidationGroup="Mandatory" Display="Dynamic" Text="Enter Suburb/Town" ControlToValidate="txttown"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="textdummy">
                                            ...
                                            <tr>
                                                <td>
                                                    State/Province<asp:Label ID="Label9" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td align="left">
                                                    &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfvstate" runat="server" Class="vldRequiredSkin"
                                                        ValidationGroup="Mandatory" Display="Dynamic" Text="Enter State/Province" ControlToValidate="txtstate"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="textdummy">
                                            ...
                                            <tr>
                                                <td>
                                                    Post/Zip Code<asp:Label ID="Label10" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td align="left">
                                                    &nbsp;&nbsp;<asp:RequiredFieldValidator ID="rfvzip" runat="server" Class="vldRequiredSkin"
                                                        ValidationGroup="Mandatory" Display="Dynamic" Text="Enter Post/Zip Code" ControlToValidate="txtzip"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="textdummy">
                                   ...
                                   <%-- <td width="2%">
                                    ...
                                    <td class="tx_1" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="170px"><span class="form_1"> 
                                                    First Name<asp:Label ID="Label11" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label></span> 
                                                </td>
                                           ...
                                           <%-- <tr>
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Last Name:<asp:Label ID="Label12" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label></span> 
                                                </td>
                                           ...
                                           <%-- <tr>
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Postion:<asp:Label ID="Label13" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td><span class="form_2"> 
                                        ...
                                        <%--    <tr>
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Phone:<asp:Label ID="Label14" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td><span class="form_2"> 
                                        ...
                                        <%--    <tr>
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Fax:<asp:Label ID="Label15" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td><span class="form_2"> 
                                          ...
                                          <%--  <tr>
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Email:<asp:Label ID="Label16" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td><span class="form_2"> 
                                            ...
                                            <tr>
                                                <td><span class="form_1"> 
                                                    Confirm Email:<asp:Label ID="Label17" runat="server" Class="lblRequiredSkin" Visible="true"
                                                        Text="*" Width="1px"></asp:Label></span> 
                                                </td>
                                                <td><span class="form_2"> 
                          ...
                          <td  width="118px">
                            ...
                            <td align="right" width="235px">
                                ...
                                &nbsp;<asp:Label ID="Label4" runat="server" Visible="true" Text="Required Fields"
                                    ...
                                    Width="1px"></asp:Label>
                                &nbsp;<asp:Label ID="Label9" runat="server" Visible="true" Text="Required Fields" CssClass="red"
                                   ></asp:Label>
                                        </td>
                                    </tr>
                                    <%--<tr>
                                    ...
                                    <tr>
                                        <td><span class="form_1">
                                            Suburb/Town<asp:Label ID="Label10" runat="server" Class="lblRequiredSkin" Visible="true"
                                                Text="*" Width="1px"></asp:Label></span> 
                                        </td>
                                        <td><span class="form_2">
                                 ...
                                 <%--   <tr>
                                        <td><span class="form_1">
                                            State/Province:<asp:Label ID="Label20" runat="server" Class="lblRequiredSkin" Visible="true"
                                                Text="*" Width="1px"></asp:Label></span> 
                                        </td>
                                        <td><span class="form_2">
                                    ...
                                    <tr>
                                        <td><span class="form_1">
                                            Post/Zip Code:<asp:Label ID="Label21" runat="server" Class="lblRequiredSkin" Visible="true"
                                                Text="*" Width="1px"></asp:Label></span> 
                                        </td>
                                        <td><span class="form_2">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="2" cellspacing="3" border="0">
                                ...
                                <%--  <input type="checkbox" value="" name="" id="chkterms" runat="server" onclick="javascript:checkEnableSubmit();" />--%>
                                                    I have read and understand the <%--<a href="Termsandconditions.aspx" style="color: Blue;
                                                        text-decoration: none;" onclick="window.open('Termsandconditions.aspx','popup','width=800,height=600,scrollbars=yes,resizable=no,toolbar=no,directories=no,location=no,menubar=no,modal=yes,status=no,left=150,top=25'); return false">Sales Terms and Conditions
                                   ...
                                   <%-- <td align="Center">
                                        ...
                                        <input id="chkterms" type="checkbox" runat="server" />
                                    </td>
                                    <td >
        ...
        <%--<div class="span3 box2">
           <h3 class="title3">Product Highlights</h3>
        </div> --%>
        <%--</div> --%>
        <%--</div> --%>
    </asp:Panel>
