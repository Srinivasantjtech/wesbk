                        ...
                        <tr>
                           ...
                           <h3 class="title3">Contact Details</h3>
                                <table id="user" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                       <%-- <td style="width: 3%">
                                            <asp:Label ID="Label33" runat="server" Class="lblRequiredSkin" Visible="false" meta:resourcekey="LblStar"></asp:Label>
                                        </td>--%>
                                        <td style="width: 30%">
                                             <span class="form_1">
                                    ...
                                    <tr>
                                       <%-- <td>
                                            <asp:Label ID="Label36" runat="server" Class="lblRequiredSkin" Visible="false" meta:resourcekey="LblStar"></asp:Label>
                                        </td>--%>
                                        <td>
                                        <span class="form_1">
                                    ...
                                    <tr>
                                        ...
                                        <%
                                                ...
                                                {
                                            %>
                                            <%--                                         <asp:RequiredFieldValidator ID="rfvAltEmail" runat="server" meta:resourcekey="valRegEx" ControlToValidate="txtAltEmail" ValidationGroup="Mandatory" Class="vldRequiredSkin" TabIndex="564" SetFocusOnError="true"></asp:RequiredFieldValidator><br/>
                                            --%>
                           ...
                           <h3 class="title3">Billing information</h3>
                             <table id="Table1" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:RequiredFieldValidator ID="rfvbAdd1" runat="server" ControlToValidate="txtbillAdd1"
