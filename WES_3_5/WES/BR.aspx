<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BR.aspx.cs" Inherits="WES.BR" %>
...
<div class="onlineInv_payment-wrap">
	<div class="title_wrap">
		...
		<span class="payment_caption"> Your order is awaiting payment. Please pay 

below</span>
	</div>
	<div class="onlineInv_lft">
		<b>Invoice Details</b>
...
Text=""></asp:Label></span> </li>
		...
		<div class="viewInvoice">
			<a href="#" class="viewInv_btn"> <img src="../images/pdf_icon.jpg"> 

</img><span> View Invoice <span></a>
		</div>
		<div class="invTotal">
			<b>Invoice Total: $<asp:Label ID="lblinvoicetotal" runat="server" 
...
value="Loading...">
        ...
        Transaction Approved! <br/> Your Order will now be processed, Thanks for shopping at Wagner Online! 
...
class="accordion_head_yellow gray_40">
       Transaction failed!
