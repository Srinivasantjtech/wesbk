...
namespace TradingBell.WebCat.EasyAsk
{
    ...
    public class EasyAsk_WES
    {
      ...
      //Added by indu
        ...
        public DataTable GetMainMenuClickDetailJson_cid(string Cid)
        {
            ...
            try
            {
                ...
                string CatName = "";
                //tmptbl = GetCategoryAndBrand("MainCategory").Tables[0].Select("CATEGORY_ID='" + Cid + "'").CopyToDataTable();
                DataSet mainds = (DataSet)HttpContext.Current.Session["MainCategory"];
                DataRow[] tmptbl_rw = mainds.Tables[0].Select("CATEGORY_ID='" + Cid + "'");
        ...
        {
            //objErrorhandler.CreateLog_connection("GetCategoryAndBrand");
            IRemoteEasyAsk ea = Impl.RemoteFactory.create(EasyAsk_URL, EasyAsk_Port, EasyAsk_WesCatBrandDictionary);
            IOptions opts = ea.getOptions();
        ...
        {
           // objErrorhandler.CreateLog(ReturnType);
            ...
            try
            {
                ...
                if (ReturnType == "MainCategory")
                {
                    //objErrorhandler.CreateLog(strxml + "\\" + "Mainds.txt");
                ...
                if (ReturnType == "New Products")
                {
                    ...
                    using (StreamReader cidtxt = File.OpenText(strxml + "\\" + "NProducts.txt"))
                    {
                        using (JsonReader reader = new JsonTextReader(cidtxt))
                        {
                            JsonSerializer serializer = new JsonSerializer();
        ...
        public DataSet LoadLinkTXT(string login)
        {
            ...
            try
            {
                ...
                if (login == "postlogin")
                {
                    path = System.Configuration.ConfigurationManager.AppSettings["CDNBANNER"].ToString() + "PostLogin" + "/";
                }
                else if (login == "prelogin")
                {
                    path = System.Configuration.ConfigurationManager.AppSettings["CDNBANNER"].ToString() + "PreLogin" + "/";
                }
                else if (login == "cartcontents")
                {
                    path = System.Configuration.ConfigurationManager.AppSettings["CDNBANNER"].ToString() + "CartContents" + "/";
                }
        ...
        public void Create_NewProducts_Json()
        {
            ...
            try
            {
                ...
                System.IO.File.WriteAllText(strxml + "\\" + "NProducts.txt", jsoncid);
        ...
        {           
            try
            {
                ...
                //objErrorhandler.CreateLog_connection("GetBrandAndModelProducts");
                IRemoteEasyAsk ea = Impl.RemoteFactory.create(EasyAsk_URL, EasyAsk_Port, EasyAsk_WebCatDictionary);
                IOptions opts = ea.getOptions();
                  ...
                  /*  DataColumn dc = new DataColumn("QTY_AVAIL", typeof(string));
                   ...
                   // ds.Columns.Add("CATEGORY_PATH", typeof(string));
                    ...
                    foreach (DataRow dr in ds.Rows)
                    {
                        ...
                        if (Convert.ToInt32(dr["PRODUCT_COUNT"]) > 1)
                        {
                            try
                            {
                                DataSet tmpds = objhelperDb.GetDataSetDB("exec [STP_GETFAMILY_STARTING_PRICE_WES] " + userid + ",'" + dr["FAMILY_ID"] + "',1");
                     ...
                     // } 
                        ...
                        if (tmpstr != string.Empty)
                        {
                           ...
                           // objErrorhandler.CreateLog(WesCatalogId + "---" + "GET_FAMILY_CATEGORY");
                            ...
                            if (tmpstr.EndsWith("'") == false && tmpstr.StartsWith("'") == true)
                            {
                                tmpstr =  tmpstr + "'";
                            }
                            Sqltb = (DataTable)objhelperDb.GetGenericDataDB(WesCatalogId, tmpstr, "GET_FAMILY_CATEGORY", HelperDB.ReturnType.RTTable);
                   ...
                   // objErrorhandler.CreateLog(HttpContext.Current.Request.Url.ToString() +"easyask ps");
                    ...
                    if (HttpContext.Current.Request.Url.ToString().ToLower().Contains("powersearch.aspx"))
                    {
                        if (attributetype.ToLower() != "category")
                        {
                            ...
                            //    objErrorhandler.CreateLog(tmpstr + attributevalue +"inside !category");
                    ...
                    //{
                        if (tmpstrPid != string.Empty)
                        {
                            ...
                            // objErrorhandler.CreateLog("tmpstrPid " + tmpstrPid + "userid" + userid);
                            if (tmpDs != null)
                            {
                                Sqltb = tmpDs.Tables[0];
                                if (Sqltb != null)
                                        ...
                                        try
                                        {
                                            foreach (DataRow dr1 in ds.Rows)
                                            {
                                                ...
                                                if (dr["PRODUCT_ID"].ToString() == dr1["PRODUCT_ID"].ToString())
                                                {
                                                    ...
                                                    //   objErrorhandler.CreateLog("EBAY_BLOCK -->" + dr["EBAY_BLOCK"].ToString());
                                                    dr1["STOCK_STATUS_DESC"] = dr["PROD_STK_STATUS_DSC"];
                                                    dr1["PROD_STOCK_STATUS"] = dr["PROD_STOCK_STATUS"];
                                                    dr1["EBAY_BLOCK"] = dr["EBAY_BLOCK"];
                            ...
                            foreach (DataRow dr in Sqltbs.Tables[0].Rows)
                            {
                                foreach (DataRow dr1 in ds.Rows)
                                {
                                    ...
                                    if (dr["PRODUCT_ID"].ToString() == dr1["PRODUCT_ID"].ToString())
                                    {
                                        ...
                                        dr1["EBAY_BLOCK"] = dr["EBAY_BLOCK"].ToString();
                        ...
                        if (Sqltb != null)
                        {
                            foreach (DataRow dr in Sqltb.Rows)
                            {
                               ...
                               // objErrorhandler.CreateLog("EBAY_BLOCK -->" + dr["EBAY_BLOCK"].ToString());
                                ...
                                dRow["EBAY_BLOCK"] = dr["EBAY_BLOCK"].ToString();
                                dRow["ETA"] = dr["ETA"].ToString();
                                try
                                {
        ...
        public DataSet GetAttributeProductsJson(string DataPage, string SearchStr, string AttributeType, string AttributeValue, string Brand, string resultPerPage, string CurrentPageNo, string NextPage, string EA)
        {
          ...
          //  objErrorhandler.CreateLog_connection(HttpContext.Current.Request.RawUrl.ToString()+     "DataPage-" + DataPage + "SearchSt-r " + SearchStr + "AttributeType-" + AttributeType + "AttributeValue-" + AttributeValue + "Brand-" + resultPerPage + "CurrentPageNo" + CurrentPageNo + "NextPage" + "ea-" + EA);
            ...
            try
            {
                ...
                if (DataPage == "FamilyPage")//|| DataPage == "ProductPage"
                {
                    ...
                    //objErrorhandler.CreateLog(flpagecnt);
                    bool checkflpagecnt = true;
                    try
                    {
                      // objErrorhandler.CreateLog("SELECT  COUNT(FAMILY_ID)   FROM [REP_PROD_DB].[dbo].TB_FAMILY  where PARENT_FAMILY_ID = '" + AttributeValue + "'");
                        DataSet tmpds = objhelperDb.GetDataSetDB("SELECT  COUNT(FAMILY_ID)   FROM [REP_PROD_DB].[dbo].TB_FAMILY  where PARENT_FAMILY_ID = '" + AttributeValue + "' AND PUBLISH=1");
                        ...
                        if (tmpds != null)
                        {
                            if (tmpds.Tables[0].Rows[0][0].ToString() != "")
                            {
                                ...
                                if (Convert.ToInt16(tmpds.Tables[0].Rows[0][0].ToString()) > 0)
                                {
                                    checkflpagecnt = false;
                                    //objErrorhandler.CreateLog("subfamily count " + AttributeValue + "--" + tmpds.Tables[0].Rows[0][0].ToString());
                                }
                            }
                        }
                    }
                    ...
                    {
                        //objErrorhandler.CreateLog("Familypagecnt" + "100"); 
                        opts.setResultsPerPage("100");
                    }
                            ...
                            else if (AttributeType == "FamilyId")
                            {
                                ...
                                if (HttpContext.Current.Session["EA"] != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (HttpContext.Current.Request["SearchStr"] != null && HttpContext.Current.Request["SearchStr"].ToString() != "")
                                        {
                                            SearchStr = HttpContext.Current.Request["SearchStr"].ToString();
                                            HttpContext.Current.Session["EA"] = HttpContext.Current.Session["EA"].ToString() + "////" + "UserSearch=Family Id=" + AttributeValue;
                                            res = ea.userSearch(HttpUtility.UrlEncode(HttpContext.Current.Session["EA"].ToString().Trim()), SearchStr);
                                        }
                                        else {
                ...
                if (DataPage.ToLower() != "powersearch")
                {
                    ...
                    //    if (DataPage == "FamilyPage")
                    //    {
                    //        objErrorhandler.CreateLog(EA.ToString());
                    //        SearchStr = HttpContext.Current.Request["SearchStr"].ToString();
                    //        res = ea.userSearch(HttpUtility.UrlEncode(EA.ToString().Trim()), SearchStr);
                    //         last = res.getLastItemJson();
                    //    }
                    //}
            ...
            catch (Exception ex)
            {
                ...
                objErrorhandler.CreateLog();
                objErrorhandler.CreateLog(ex.ToString());
                objErrorhandler.CreateLog(HttpContext.Current.Request.RawUrl);
        ...
        public DataSet GetWESModelJson(string parentCategoryName, int CatalogID, string tosuite_brand)
        {
            ...
            //objErrorhandler.CreateLog_connection("parentCategoryName" + parentCategoryName + "CatalogID" + CatalogID + "tosuite_brand" + tosuite_brand);
